...
MeshComponent::MeshComponent(const std::string& entityID, PrimType type, const GLvoid* vertices, 
...
{
  if(type == MeshComponent::TRIANGLES){
    _primitive = GL_TRIANGLES;
  }else if(type == MeshComponent::POINTS)
  {
